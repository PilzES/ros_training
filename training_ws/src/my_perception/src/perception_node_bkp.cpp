...
int main(int argc, char *argv[])
{
  ...
  cloud_topic = priv_nh_.param<std::string>("cloud_topic", "/camera/depth/color/points");
  world_frame = priv_nh_.param<std::string>("world_frame", "prbt_base");
  camera_frame = priv_nh_.param<std::string>("camera_frame", "camera_depth_frame");
