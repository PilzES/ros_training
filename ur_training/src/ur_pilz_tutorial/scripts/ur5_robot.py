...
"""API for easy usage of ur5 Robot."""

#from __future__ import absolute_import MSAN: Not Necessary
import psutil
import time
import threading
...
import tf2_ros
#import tf2_geometry_msgs  #MSAN: NOT used

from moveit_msgs.msg import MoveGroupSequenceAction
#from pilz_msgs.msg import IsBrakeTestRequiredResult # MSAN: Not Present in UR5
#from pilz_msgs.srv import GetSpeedOverride, IsBrakeTestRequired, BrakeTest # MSAN: Not Present in UR5

from pilz_robot_programming.move_control_request import _MoveControlStateMachine, MoveControlAction, _MoveControlState
from pilz_robot_programming.commands import _AbstractCmd, Sequence # MSAN: Other are defined by us
from pilz_robot_programming.exceptions import *
...
class Robot(object):
    ...
    * :py:class:`.Gripper`
    ...
    #_BRAKE_TEST_EXECUTE_SRV = "/prbt/execute_braketest" MSAN: UR5 does not has this feauture
    #_GET_SPEED_OVERRIDE_SRV = "/prbt/get_speed_override" MSAN: UR5 does not has this feauture
    #_BRAKE_TEST_REQUIRED_SRV = "/prbt/brake_test_required" MSAN: UR5 does not has this feauture
    ...
    def __init__(self, version=None, *args, **kwargs):
        ...
        rospy.logdebug("Initialize UR5 Robot class")
        ...
        # self._check_version(version) MSAN: We Don't consider the API version
    ...
    def _speed_override(self):
        ...
        # MSAN: UR5 Robot doesn't have this property, but is needed for commands constructor  
        # Just set as integer 1, should not has nothing to do
        return 1.0
    ...
    def _establish_connections(self):
        ...
        # Connect to speed override service NOT NEED fo UR5 Robot
